...
%The coupling of the boson current $\cJ_\rho$ to $\Aext_\rho$ is standard.  %(e.g., this gives standard form when the partition sum is expressed in terms of the integer-valued electromagnetic field tensor).
...
%If symmetries are broken or $c$ is even, the 
